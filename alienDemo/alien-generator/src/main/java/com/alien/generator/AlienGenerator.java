...
public class AlienGenerator {
     ...
     * (文件自动生成至该模块下)
     */
    private static final String module = "/alien-modules/alien-core";
     ...
     * (文件自动生成至该包下)
     */
    private static final String daoPackage = "com.alien.your.dao";
    ...
    public static void main(String[] args) throws IOException {
        ...
        // 模板路径
        String root = System.getProperty("user.dir")+"/alien-generator/src/main/java/com/alien/generator/template";
