package com.alien.generator;
import com.alien.generator.bean.Entity;
...
import static com.alien.generator.AlienGenerator.*;
...
public class AlienMPGenerator {
     ...
     * 建议仅需修改
     */
    private static final String author = "alien";
     ...
     * (文件自动生成至该模块下)
     */
    private static final String module = "/alien-modules/alien-your";

    /**
     * 实体类对应包
     * (文件自动生成至该包下)
     */
    private static final String entityPackage = "com.alien.your.entity";

    /**
     * dao对应包 【注意修改后需到com.alien.core.config.mybatisplus.MybatisPlusConfig配置你的mapper路径扫描】
     * (文件自动生成至该包下)
     */
    private static final String daoPackage = "com.alien.your.mapper";

    /**
     * service对应包
     * (文件自动生成至该包下)
     */
    private static final String servicePackage = "com.alien.your.service";

    /**
     * serviceImpl对应包
     * (文件自动生成至该包下)
     */
    private static final String serviceImplPackage = "com.alien.your.serviceimpl";

    /**
     * controller对应包
     * (文件自动生成至该包下)
     */
    private static final String controllerPackage = "com.alien.your.controller";
    ...
    public static void main(String[] args) throws IOException {
        ...
        // 模板路径
        String root = System.getProperty("user.dir")+"/alieb-generator/src/main/java/com/alien/generator/template";
