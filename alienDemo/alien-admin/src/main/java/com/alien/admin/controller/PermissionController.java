...
import com.alien.admin.config.security.permission.MySecurityMetadataSource;
import com.alien.admin.entity.Permission;
import com.alien.admin.entity.RolePermission;
import com.alien.admin.entity.User;
import com.alien.admin.service.PermissionService;
import com.alien.admin.service.RolePermissionService;
import com.alien.admin.service.mybatis.IPermissionService;
import com.alien.admin.util.VoUtil;
...
@Slf4j
@RestController
@Api(value = "permission",tags = "字菜单/权限管理API")
@RequestMapping("/alien/permission")
