...
import com.alien.admin.service.DictDataService;
import com.alien.admin.service.DictService;
...
@Slf4j
@RestController
@Api(value = "dict",tags = "字典管理API")
@RequestMapping("/alien/dict")
@Transactional
public class DictController extends BaseController <Dict,String>{
    ...
    @Override
    public BaseService<Dict, String> getService() {
        return dictService;
    }
